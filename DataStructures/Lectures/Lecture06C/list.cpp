...
*************************************************************************/
List::List(const List& origList) : mySize(origList.mySize), myCapacity(origList.myCapacity)  // myCapacity & mysize are private class variables
{
...
*************************************************************************/
void List::insert(ElementType item, int pos)                        // Definition of insert()
{
